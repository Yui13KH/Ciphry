...
static Cipher cipher_list[] = {
    ...
    {"affine", affine_run, print_affine_help,
     "Affine cipher with keys a (coprime) and b for linear transformation"},
    ...
    {"xor", xor_run, print_xor_help,
     "XOR cipher: bitwise exclusive OR with repeating key (symmetric "
     "encryption)"},
